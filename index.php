...
<div>
  <form>
    <input type="button" value="Show ER-Diagram" class="btn btn-outline-info btn-lg float-left ml-5 mb-5" onclick="window.location.href='er_diagram/er.php'" />
  </form>
  </div>
<div>
  <form>
    
    <input type="button" value="Project Proposal" class="btn btn-outline-info btn-lg float-left ml-5 mt-5" onclick="window.location.href='summary/summary.php'" />
  </form>
  </div>
</div>
