...
<body>
  ...
  <form>
    <input type="button" value="Show ER-Diagram" class="btn btn-outline-info btn-lg float-right mr-50" onclick="window.location.href='https://yifei.uqcloud.net/MDPS/er_diagram/er.php'" />
  </form>
